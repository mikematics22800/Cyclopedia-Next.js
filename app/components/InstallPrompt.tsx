...
export default function InstallPrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:max-w-md bg-blue-600 text-white p-4 rounded-lg shadow-lg z-[999] flex items-center justify-between gap-4">
